# M3 SDK Manual
Download PDF: [M3SDK_Manual_en_v2.3.14.pdf](https://github.com/m3mobile/M3SDK/releases/download/2.3.14/M3SDK_Manual_en_v2.3.14.pdf)
...
// Kotlin
dependencies {
    implementation("com.github.m3mobile:M3SDK:2.3.14")
}
```
