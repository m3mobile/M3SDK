...
NuGet package: [M3Mobile.M3Sdk.Xamarin 2.3.4](https://www.nuget.org/packages/M3Mobile.M3Sdk.Xamarin/2.3.4)
...
```powershell
Install-Package M3Mobile.M3Sdk.Xamarin -Version 2.3.4
```
...
```xml
<PackageReference Include="M3Mobile.M3Sdk.Xamarin" Version="2.3.4" />
```
