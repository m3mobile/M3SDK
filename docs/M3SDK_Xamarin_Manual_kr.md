...
NuGet 배포 링크 : [M3Mobile.M3Sdk.Xamarin 2.3.0-alpha01](https://www.nuget.org/packages/M3Mobile.M3Sdk.Xamarin/2.3.0-alpha01)
...
```powershell
Install-Package M3Mobile.M3Sdk.Xamarin -Version 2.3.0-alpha01
```
...
```xml
<PackageReference Include="M3Mobile.M3Sdk.Xamarin" Version="2.3.0-alpha01" />
```
