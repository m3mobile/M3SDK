...
internal class GetScanResultPrefixRequester(override val context: Context): AwaitableBroadcastRequester<String>() {
    ...
    override fun getExtra(intent: Intent): String? {
        return intent.getStringExtra("m3scanner_prefix")
    }
}