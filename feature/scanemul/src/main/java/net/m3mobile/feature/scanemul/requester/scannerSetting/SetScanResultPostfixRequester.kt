...
internal class SetScanResultPostfixRequester(
    ...
    override val typeValue = TypeValue.SET_SCAN_RESULT_POSTFIX
    override val extras = bundleOf(ExtraKey.POSTFIX to postfix)
}