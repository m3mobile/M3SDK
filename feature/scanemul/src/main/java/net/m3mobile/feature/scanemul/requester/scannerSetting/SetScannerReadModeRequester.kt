...
internal class SetScannerReadModeRequester(
    ...
    override val typeValue = TypeValue.SET_SCANNER_READ_MODE
    override val extras = bundleOf(ExtraKey.READ_MODE to mode.value)
}